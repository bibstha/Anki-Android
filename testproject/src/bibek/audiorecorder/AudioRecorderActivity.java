...
public class AudioRecorderActivity extends Activity
{
    ...
    {
        Log.d("MainActivity", "Here Now");
        super.onActivityResult(requestCode, resultCode, data);
        if (data != null)
        {
            Intent i = new Intent("asdf");
            Serializable media = i.getSerializableExtra("pickedMedia");
            if (media instanceof PickedMedia)
            {
                PickedMedia pickedMedia = (PickedMedia) media;
                Log.d("OUR MEDIA", pickedMedia.toString());
            }
        }
    }
